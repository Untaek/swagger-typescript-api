...
export type IMySuperPrefixListDataSetsDataMySuperSuffix =
  IMySuperPrefixDataSetListMySuperSuffix;

export type IMySuperPrefixListSearchableFieldsDataMySuperSuffix = string;

export type IMySuperPrefixListSearchableFieldsErrorMySuperSuffix = string;

export type IMySuperPrefixPerformSearchDataMySuperSuffix = Record<
  string,
  object
>[];
...
> extends HttpClient<SecurityDataType> {
  ...
  listDataSets = (params: RequestParams = {}) =>
    this.request<IMySuperPrefixListDataSetsDataMySuperSuffix, any>({
      path: `/`,
      method: "GET",
      ...params,
    });
  ...
  dataset = {
    ...
    listSearchableFields: (
      ...
      this.request<
        IMySuperPrefixListSearchableFieldsDataMySuperSuffix,
        IMySuperPrefixListSearchableFieldsErrorMySuperSuffix
      >({
    ...
    performSearch: (
      ...
      this.request<IMySuperPrefixPerformSearchDataMySuperSuffix, void>({
