...
export type IMySuperPrefixListPetsDataMySuperSuffix = object;
...
> extends HttpClient<SecurityDataType> {
  foobarbaz = {
     ...
     */
    listPets: (
      { query, ...queryParams }: IMySuperPrefixListPetsParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixListPetsDataMySuperSuffix, any>({
