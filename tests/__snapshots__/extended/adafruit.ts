...
export type IMySuperPrefixAddFeedToGroupDataMySuperSuffix =
  IMySuperPrefixGroupMySuperSuffix;
...
export type IMySuperPrefixAllActivitiesDataMySuperSuffix =
  IMySuperPrefixActivityMySuperSuffix[];
...
export type IMySuperPrefixAllBlocksDataMySuperSuffix =
  IMySuperPrefixBlockMySuperSuffix[];

export type IMySuperPrefixAllDashboardsDataMySuperSuffix =
  IMySuperPrefixDashboardMySuperSuffix[];

export type IMySuperPrefixAllDataDataMySuperSuffix =
  IMySuperPrefixDataResponseMySuperSuffix[];
...
export type IMySuperPrefixAllFeedsDataMySuperSuffix =
  IMySuperPrefixFeedMySuperSuffix[];

export type IMySuperPrefixAllGroupFeedDataDataMySuperSuffix =
  IMySuperPrefixDataResponseMySuperSuffix[];
...
export type IMySuperPrefixAllGroupFeedsDataMySuperSuffix =
  IMySuperPrefixFeedMySuperSuffix[];

export type IMySuperPrefixAllGroupsDataMySuperSuffix =
  IMySuperPrefixGroupMySuperSuffix[];

export type IMySuperPrefixAllPermissionsDataMySuperSuffix =
  IMySuperPrefixPermissionMySuperSuffix[];

export type IMySuperPrefixAllTokensDataMySuperSuffix =
  IMySuperPrefixTokenMySuperSuffix[];

export type IMySuperPrefixAllTriggersDataMySuperSuffix =
  IMySuperPrefixTriggerMySuperSuffix[];

export type IMySuperPrefixBatchCreateDataDataMySuperSuffix =
  IMySuperPrefixDataResponseMySuperSuffix[];

export type IMySuperPrefixBatchCreateGroupFeedDataDataMySuperSuffix =
  IMySuperPrefixDataResponseMySuperSuffix[];
...
export interface IMySuperPrefixChartDataDataMySuperSuffix {
...
export type IMySuperPrefixCreateBlockDataMySuperSuffix =
  IMySuperPrefixBlockMySuperSuffix;

export type IMySuperPrefixCreateDashboardDataMySuperSuffix =
  IMySuperPrefixDashboardMySuperSuffix;

export type IMySuperPrefixCreateDataDataMySuperSuffix =
  IMySuperPrefixDataMySuperSuffix;

export type IMySuperPrefixCreateFeedDataMySuperSuffix =
  IMySuperPrefixFeedMySuperSuffix;
...
export type IMySuperPrefixCreateGroupDataDataMySuperSuffix =
  IMySuperPrefixDataResponseMySuperSuffix[];

export type IMySuperPrefixCreateGroupDataMySuperSuffix =
  IMySuperPrefixGroupMySuperSuffix;
...
export type IMySuperPrefixCreateGroupFeedDataDataMySuperSuffix =
  IMySuperPrefixDataResponseMySuperSuffix;

export type IMySuperPrefixCreateGroupFeedDataMySuperSuffix =
  IMySuperPrefixFeedMySuperSuffix;

export type IMySuperPrefixCreatePermissionDataMySuperSuffix =
  IMySuperPrefixPermissionMySuperSuffix;

/** @default "r" */
export enum IMySuperPrefixCreatePermissionModeEnumMySuperSuffix {
  R = "r",
  W = "w",
  Rw = "rw",
}
...
/** @default "public" */
export enum IMySuperPrefixCreatePermissionScopeEnumMySuperSuffix {
  Secret = "secret",
  Public = "public",
  User = "user",
...
export type IMySuperPrefixCreateRawWebhookFeedDataDataMySuperSuffix =
  IMySuperPrefixDataMySuperSuffix;

export type IMySuperPrefixCreateTokenDataMySuperSuffix =
  IMySuperPrefixTokenMySuperSuffix;

export type IMySuperPrefixCreateTriggerDataMySuperSuffix =
  IMySuperPrefixTriggerMySuperSuffix;

export type IMySuperPrefixCreateWebhookFeedDataDataMySuperSuffix =
  IMySuperPrefixDataMySuperSuffix;
...
export type IMySuperPrefixCurrentUserDataMySuperSuffix =
  IMySuperPrefixUserMySuperSuffix;
...
export type IMySuperPrefixDestroyActivitiesDataMySuperSuffix = any;

export type IMySuperPrefixDestroyBlockDataMySuperSuffix = string;

export type IMySuperPrefixDestroyDashboardDataMySuperSuffix = string;

export type IMySuperPrefixDestroyDataDataMySuperSuffix = string;

export type IMySuperPrefixDestroyFeedDataMySuperSuffix = any;

export type IMySuperPrefixDestroyGroupDataMySuperSuffix = string;

export type IMySuperPrefixDestroyPermissionDataMySuperSuffix = string;

export type IMySuperPrefixDestroyTokenDataMySuperSuffix = string;

export type IMySuperPrefixDestroyTriggerDataMySuperSuffix = string;
...
export interface IMySuperPrefixFeedMySuperSuffix {
  ...
  updated_at?: string;
  /** @default "private" */
  visibility?: IMySuperPrefixFeedVisibilityEnumMySuperSuffix;
}

/** @default "private" */
export enum IMySuperPrefixFeedVisibilityEnumMySuperSuffix {
  Private = "private",
  Public = "public",
  InProgress = "in progress",
  OutOfAccess = "out of access",
}

export type IMySuperPrefixFirstDataDataMySuperSuffix =
  IMySuperPrefixDataResponseMySuperSuffix;
...
export type IMySuperPrefixGetActivityDataMySuperSuffix =
  IMySuperPrefixActivityMySuperSuffix[];
...
export type IMySuperPrefixGetBlockDataMySuperSuffix =
  IMySuperPrefixBlockMySuperSuffix;

export interface IMySuperPrefixGetCurrentUserThrottleDataMySuperSuffix {
...
export type IMySuperPrefixGetDashboardDataMySuperSuffix =
  IMySuperPrefixDashboardMySuperSuffix;

export type IMySuperPrefixGetDataDataMySuperSuffix =
  IMySuperPrefixDataResponseMySuperSuffix;
...
export type IMySuperPrefixGetFeedDataMySuperSuffix =
  IMySuperPrefixFeedMySuperSuffix;

export type IMySuperPrefixGetFeedDetailsDataMySuperSuffix =
  IMySuperPrefixFeedMySuperSuffix;

export type IMySuperPrefixGetGroupDataMySuperSuffix =
  IMySuperPrefixGroupMySuperSuffix;

export type IMySuperPrefixGetPermissionDataMySuperSuffix =
  IMySuperPrefixPermissionMySuperSuffix;

export type IMySuperPrefixGetTokenDataMySuperSuffix =
  IMySuperPrefixTokenMySuperSuffix;

export type IMySuperPrefixGetTriggerDataMySuperSuffix =
  IMySuperPrefixTriggerMySuperSuffix;
...
export type IMySuperPrefixLastDataDataMySuperSuffix =
  IMySuperPrefixDataResponseMySuperSuffix;
...
export type IMySuperPrefixNextDataDataMySuperSuffix =
  IMySuperPrefixDataResponseMySuperSuffix;
...
/** @default "feed" */
export enum IMySuperPrefixPermissionModelEnumMySuperSuffix {
  Feed = "feed",
  Group = "group",
  Dashboard = "dashboard",
}
...
export interface IMySuperPrefixPermissionMySuperSuffix {
  ...
  id?: number;
  /** @default "feed" */
  model?: IMySuperPrefixPermissionModelEnumMySuperSuffix;
  object_id?: number;
  /** @default "public" */
  scope?: IMySuperPrefixPermissionScopeEnumMySuperSuffix;
  scope_value?: string;
  updated_at?: string;
  user_id?: number;
}
...
/** @default "public" */
export enum IMySuperPrefixPermissionScopeEnumMySuperSuffix {
  Secret = "secret",
  Public = "public",
  User = "user",
  Organization = "organization",
...
export type IMySuperPrefixPreviousDataDataMySuperSuffix =
  IMySuperPrefixDataResponseMySuperSuffix;
...
export type IMySuperPrefixRemoveFeedFromGroupDataMySuperSuffix =
  IMySuperPrefixGroupMySuperSuffix;
...
export type IMySuperPrefixReplaceBlockDataMySuperSuffix =
  IMySuperPrefixBlockMySuperSuffix;

export type IMySuperPrefixReplaceDashboardDataMySuperSuffix =
  IMySuperPrefixDashboardMySuperSuffix;

export type IMySuperPrefixReplaceDataDataMySuperSuffix =
  IMySuperPrefixDataResponseMySuperSuffix;

export type IMySuperPrefixReplaceFeedDataMySuperSuffix =
  IMySuperPrefixFeedMySuperSuffix;

export type IMySuperPrefixReplaceGroupDataMySuperSuffix =
  IMySuperPrefixGroupMySuperSuffix;

export type IMySuperPrefixReplacePermissionDataMySuperSuffix =
  IMySuperPrefixPermissionMySuperSuffix;

export type IMySuperPrefixReplaceTokenDataMySuperSuffix =
  IMySuperPrefixTokenMySuperSuffix;

export type IMySuperPrefixReplaceTriggerDataMySuperSuffix =
  IMySuperPrefixTriggerMySuperSuffix;

export type IMySuperPrefixRetainDataDataMySuperSuffix = string;
...
export type IMySuperPrefixUpdateBlockDataMySuperSuffix =
  IMySuperPrefixBlockMySuperSuffix;

export type IMySuperPrefixUpdateDashboardDataMySuperSuffix =
  IMySuperPrefixDashboardMySuperSuffix;

export type IMySuperPrefixUpdateDataDataMySuperSuffix =
  IMySuperPrefixDataResponseMySuperSuffix;

export type IMySuperPrefixUpdateFeedDataMySuperSuffix =
  IMySuperPrefixFeedMySuperSuffix;

export type IMySuperPrefixUpdateGroupDataMySuperSuffix =
  IMySuperPrefixGroupMySuperSuffix;

export type IMySuperPrefixUpdatePermissionDataMySuperSuffix =
  IMySuperPrefixPermissionMySuperSuffix;

export type IMySuperPrefixUpdateTokenDataMySuperSuffix =
  IMySuperPrefixTokenMySuperSuffix;

export type IMySuperPrefixUpdateTriggerDataMySuperSuffix =
  IMySuperPrefixTriggerMySuperSuffix;
...
> extends HttpClient<SecurityDataType> {
  user = {
    ...
    currentUser: (params: RequestParams = {}) =>
      this.request<IMySuperPrefixCurrentUserDataMySuperSuffix, void>({
        path: `/user`,
        method: "GET",
        secure: true,
        ...params,
  ...
  webhooks = {
    ...
    createRawWebhookFeedData: (token: string, params: RequestParams = {}) =>
      this.request<
        IMySuperPrefixCreateRawWebhookFeedDataDataMySuperSuffix,
        void
      >({
    ...
    createWebhookFeedData: (
      ...
      this.request<IMySuperPrefixCreateWebhookFeedDataDataMySuperSuffix, void>({
  ...
  username = {
    ...
    addFeedToGroup: (
      {
        ...
        username,
        ...query
      }: IMySuperPrefixAddFeedToGroupParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixAddFeedToGroupDataMySuperSuffix, void>({
    ...
    allActivities: (
      ...
      this.request<IMySuperPrefixAllActivitiesDataMySuperSuffix, void>({
    ...
    allBlocks: (
      ...
      this.request<IMySuperPrefixAllBlocksDataMySuperSuffix, void>({
    ...
    allDashboards: (username: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixAllDashboardsDataMySuperSuffix, void>({
     ...
     */
    allData: (
      { username, feedKey, ...query }: IMySuperPrefixAllDataParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixAllDataDataMySuperSuffix, void>({
    ...
    allFeeds: (username: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixAllFeedsDataMySuperSuffix, void>({
        path: `/${username}/feeds`,
        method: "GET",
        secure: true,
        ...params,
    ...
    allGroupFeedData: (
      {
        ...
        feedKey,
        ...query
      }: IMySuperPrefixAllGroupFeedDataParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixAllGroupFeedDataDataMySuperSuffix, void>({
    ...
    allGroupFeeds: (
      ...
      this.request<IMySuperPrefixAllGroupFeedsDataMySuperSuffix, void>({
    ...
    allGroups: (username: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixAllGroupsDataMySuperSuffix, void>({
    ...
    allPermissions: (
      ...
      this.request<IMySuperPrefixAllPermissionsDataMySuperSuffix, void>({
    ...
    allTokens: (username: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixAllTokensDataMySuperSuffix, void>({
    ...
    allTriggers: (username: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixAllTriggersDataMySuperSuffix, void>({
    ...
    batchCreateData: (
      ...
      this.request<IMySuperPrefixBatchCreateDataDataMySuperSuffix, void>({
    ...
    batchCreateGroupFeedData: (
      ...
      this.request<
        IMySuperPrefixBatchCreateGroupFeedDataDataMySuperSuffix,
        void
      >({
    ...
    chartData: (
      {
        ...
        feedKey,
        ...query
      }: IMySuperPrefixChartDataParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixChartDataDataMySuperSuffix, void>({
    ...
    createBlock: (
      ...
      this.request<IMySuperPrefixCreateBlockDataMySuperSuffix, void>({
        path: `/${username}/dashboards/${dashboardId}/blocks`,
        method: "POST",
        body: block,
        secure: true,
    ...
    createDashboard: (
      ...
      this.request<IMySuperPrefixCreateDashboardDataMySuperSuffix, void>({
        path: `/${username}/dashboards`,
        method: "POST",
        body: dashboard,
        secure: true,
    ...
    createData: (
      ...
      this.request<IMySuperPrefixCreateDataDataMySuperSuffix, void>({
        path: `/${username}/feeds/${feedKey}/data`,
        method: "POST",
        body: datum,
        secure: true,
    ...
    createFeed: (
      ...
      this.request<IMySuperPrefixCreateFeedDataMySuperSuffix, void>({
        path: `/${username}/feeds`,
        method: "POST",
        query: query,
        body: feed,
    ...
    createGroup: (
      ...
      this.request<IMySuperPrefixCreateGroupDataMySuperSuffix, void>({
        path: `/${username}/groups`,
        method: "POST",
        body: group,
        secure: true,
    ...
    createGroupData: (
      ...
      this.request<IMySuperPrefixCreateGroupDataDataMySuperSuffix, void>({
    ...
    createGroupFeed: (
      ...
      this.request<IMySuperPrefixCreateGroupFeedDataMySuperSuffix, void>({
        path: `/${username}/groups/${groupKey}/feeds`,
        method: "POST",
        body: feed,
        secure: true,
    ...
    createGroupFeedData: (
      ...
      this.request<IMySuperPrefixCreateGroupFeedDataDataMySuperSuffix, void>({
        path: `/${username}/groups/${groupKey}/feeds/${feedKey}/data`,
        method: "POST",
        body: datum,
        secure: true,
    ...
    createPermission: (
      ...
      permission: {
        /** @default "r" */
        mode?: IMySuperPrefixCreatePermissionModeEnumMySuperSuffix;
        /** @default "public" */
        scope?: IMySuperPrefixCreatePermissionScopeEnumMySuperSuffix;
        scope_value?: string;
      },
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixCreatePermissionDataMySuperSuffix, void>({
        path: `/${username}/${type}/${typeId}/acl`,
        method: "POST",
        body: permission,
        secure: true,
    ...
    createToken: (
      ...
      this.request<IMySuperPrefixCreateTokenDataMySuperSuffix, void>({
        path: `/${username}/tokens`,
        method: "POST",
        body: token,
        secure: true,
    ...
    createTrigger: (
      ...
      this.request<IMySuperPrefixCreateTriggerDataMySuperSuffix, void>({
        path: `/${username}/triggers`,
        method: "POST",
        body: trigger,
        secure: true,
    ...
    destroyActivities: (username: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixDestroyActivitiesDataMySuperSuffix, void>({
        path: `/${username}/activities`,
        method: "DELETE",
        secure: true,
        ...params,
    ...
    destroyBlock: (
      ...
      this.request<IMySuperPrefixDestroyBlockDataMySuperSuffix, void>({
    ...
    destroyDashboard: (
      ...
      this.request<IMySuperPrefixDestroyDashboardDataMySuperSuffix, void>({
    ...
    destroyData: (
      ...
      this.request<IMySuperPrefixDestroyDataDataMySuperSuffix, void>({
    ...
    destroyFeed: (
      ...
      this.request<IMySuperPrefixDestroyFeedDataMySuperSuffix, void>({
    ...
    destroyGroup: (
      ...
      this.request<IMySuperPrefixDestroyGroupDataMySuperSuffix, void>({
    ...
    destroyPermission: (
      ...
      this.request<IMySuperPrefixDestroyPermissionDataMySuperSuffix, void>({
    ...
    destroyToken: (username: string, id: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixDestroyTokenDataMySuperSuffix, void>({
    ...
    destroyTrigger: (
      ...
      this.request<IMySuperPrefixDestroyTriggerDataMySuperSuffix, void>({
    ...
    firstData: (
      {
        ...
        feedKey,
        ...query
      }: IMySuperPrefixFirstDataParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixFirstDataDataMySuperSuffix, void>({
    ...
    getActivity: (
      {
        ...
        type,
        ...query
      }: IMySuperPrefixGetActivityParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixGetActivityDataMySuperSuffix, void>({
    ...
    getBlock: (
      ...
      this.request<IMySuperPrefixGetBlockDataMySuperSuffix, void>({
        path: `/${username}/dashboards/${dashboardId}/blocks/${id}`,
        method: "GET",
        secure: true,
        ...params,
    ...
    getCurrentUserThrottle: (username: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixGetCurrentUserThrottleDataMySuperSuffix, void>(
        {
    ...
    getDashboard: (username: string, id: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixGetDashboardDataMySuperSuffix, void>({
        path: `/${username}/dashboards/${id}`,
        method: "GET",
        secure: true,
        ...params,
    ...
    getData: (
      {
        ...
        id,
        ...query
      }: IMySuperPrefixGetDataParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixGetDataDataMySuperSuffix, void>({
        path: `/${username}/feeds/${feedKey}/data/${id}`,
        method: "GET",
        query: query,
        secure: true,
    ...
    getFeed: (username: string, feedKey: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixGetFeedDataMySuperSuffix, void>({
        path: `/${username}/feeds/${feedKey}`,
        method: "GET",
        secure: true,
        ...params,
    ...
    getFeedDetails: (
      ...
      this.request<IMySuperPrefixGetFeedDetailsDataMySuperSuffix, void>({
    ...
    getGroup: (
      ...
      this.request<IMySuperPrefixGetGroupDataMySuperSuffix, void>({
        path: `/${username}/groups/${groupKey}`,
        method: "GET",
        secure: true,
        ...params,
    ...
    getPermission: (
      ...
      this.request<IMySuperPrefixGetPermissionDataMySuperSuffix, void>({
        path: `/${username}/${type}/${typeId}/acl/${id}`,
        method: "GET",
        secure: true,
        ...params,
    ...
    getToken: (username: string, id: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixGetTokenDataMySuperSuffix, void>({
        path: `/${username}/tokens/${id}`,
        method: "GET",
        secure: true,
        ...params,
    ...
    getTrigger: (username: string, id: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixGetTriggerDataMySuperSuffix, void>({
        path: `/${username}/triggers/${id}`,
        method: "GET",
        secure: true,
        ...params,
    ...
    lastData: (
      {
        ...
        feedKey,
        ...query
      }: IMySuperPrefixLastDataParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixLastDataDataMySuperSuffix, void>({
    ...
    nextData: (
      {
        ...
        feedKey,
        ...query
      }: IMySuperPrefixNextDataParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixNextDataDataMySuperSuffix, void>({
    ...
    previousData: (
      {
        ...
        feedKey,
        ...query
      }: IMySuperPrefixPreviousDataParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixPreviousDataDataMySuperSuffix, void>({
    ...
    removeFeedFromGroup: (
      {
        ...
        username,
        ...query
      }: IMySuperPrefixRemoveFeedFromGroupParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixRemoveFeedFromGroupDataMySuperSuffix, void>({
    ...
    replaceBlock: (
      ...
      this.request<IMySuperPrefixReplaceBlockDataMySuperSuffix, void>({
        path: `/${username}/dashboards/${dashboardId}/blocks/${id}`,
        method: "PUT",
        body: block,
        secure: true,
    ...
    replaceDashboard: (
      ...
      this.request<IMySuperPrefixReplaceDashboardDataMySuperSuffix, void>({
        path: `/${username}/dashboards/${id}`,
        method: "PUT",
        body: dashboard,
        secure: true,
    ...
    replaceData: (
      ...
      this.request<IMySuperPrefixReplaceDataDataMySuperSuffix, void>({
        path: `/${username}/feeds/${feedKey}/data/${id}`,
        method: "PUT",
        body: datum,
        secure: true,
    ...
    replaceFeed: (
      ...
      this.request<IMySuperPrefixReplaceFeedDataMySuperSuffix, void>({
        path: `/${username}/feeds/${feedKey}`,
        method: "PUT",
        body: feed,
        secure: true,
    ...
    replaceGroup: (
      ...
      this.request<IMySuperPrefixReplaceGroupDataMySuperSuffix, void>({
        path: `/${username}/groups/${groupKey}`,
        method: "PUT",
        body: group,
        secure: true,
    ...
    replacePermission: (
      ...
      this.request<IMySuperPrefixReplacePermissionDataMySuperSuffix, void>({
        path: `/${username}/${type}/${typeId}/acl/${id}`,
        method: "PUT",
        body: permission,
        secure: true,
    ...
    replaceToken: (
      ...
      this.request<IMySuperPrefixReplaceTokenDataMySuperSuffix, void>({
        path: `/${username}/tokens/${id}`,
        method: "PUT",
        body: token,
        secure: true,
    ...
    replaceTrigger: (
      ...
      this.request<IMySuperPrefixReplaceTriggerDataMySuperSuffix, void>({
        path: `/${username}/triggers/${id}`,
        method: "PUT",
        body: trigger,
        secure: true,
    ...
    retainData: (
      ...
      this.request<IMySuperPrefixRetainDataDataMySuperSuffix, void>({
    ...
    updateBlock: (
      ...
      this.request<IMySuperPrefixUpdateBlockDataMySuperSuffix, void>({
        path: `/${username}/dashboards/${dashboardId}/blocks/${id}`,
        method: "PATCH",
        body: block,
        secure: true,
    ...
    updateDashboard: (
      ...
      this.request<IMySuperPrefixUpdateDashboardDataMySuperSuffix, void>({
        path: `/${username}/dashboards/${id}`,
        method: "PATCH",
        body: dashboard,
        secure: true,
    ...
    updateData: (
      ...
      this.request<IMySuperPrefixUpdateDataDataMySuperSuffix, void>({
        path: `/${username}/feeds/${feedKey}/data/${id}`,
        method: "PATCH",
        body: datum,
        secure: true,
    ...
    updateFeed: (
      ...
      this.request<IMySuperPrefixUpdateFeedDataMySuperSuffix, void>({
        path: `/${username}/feeds/${feedKey}`,
        method: "PATCH",
        body: feed,
        secure: true,
    ...
    updateGroup: (
      ...
      this.request<IMySuperPrefixUpdateGroupDataMySuperSuffix, void>({
        path: `/${username}/groups/${groupKey}`,
        method: "PATCH",
        body: group,
        secure: true,
    ...
    updatePermission: (
      ...
      this.request<IMySuperPrefixUpdatePermissionDataMySuperSuffix, void>({
        path: `/${username}/${type}/${typeId}/acl/${id}`,
        method: "PATCH",
        body: permission,
        secure: true,
    ...
    updateToken: (
      ...
      this.request<IMySuperPrefixUpdateTokenDataMySuperSuffix, void>({
        path: `/${username}/tokens/${id}`,
        method: "PATCH",
        body: token,
        secure: true,
    ...
    updateTrigger: (
      ...
      this.request<IMySuperPrefixUpdateTriggerDataMySuperSuffix, void>({
        path: `/${username}/triggers/${id}`,
        method: "PATCH",
        body: trigger,
        secure: true,
