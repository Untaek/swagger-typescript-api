...
export type IMySuperPrefixCreateFileDataMySuperSuffix =
  IMySuperPrefixFloopMySuperSuffix;
...
> extends HttpClient<SecurityDataType> {
  user = {
    ...
    createFile: (
      user: string,
      data: IMySuperPrefixCreateFilePayloadMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixCreateFileDataMySuperSuffix, any>({
        path: `/${user}/foos`,
        method: "POST",
        body: data,
  ...
  something = {
     ...
     */
    gets: (
      query: IMySuperPrefixGetsParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
