...
/** travel mode */
export enum IMySuperPrefixStepModeEnumMySuperSuffix {
  Car = "car",
...
export interface IMySuperPrefixStepMySuperSuffix {
  ...
  route?: {
    ...
    duration?: number;
    /** travel mode */
    mode?: IMySuperPrefixStepModeEnumMySuperSuffix;
...
export type IMySuperPrefixStopDetailDataMySuperSuffix =
  IMySuperPrefixStepMySuperSuffix[];

export type IMySuperPrefixTripListDataMySuperSuffix =
  IMySuperPrefixTripMySuperSuffix[];
...
> extends HttpClient<SecurityDataType> {
  trip = {
    ...
    stopDetail: (tripId: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixStopDetailDataMySuperSuffix, any>({
    ...
    tripList: (params: RequestParams = {}) =>
      this.request<IMySuperPrefixTripListDataMySuperSuffix, any>({
        path: `/trip`,
        method: "GET",
        secure: true,
        ...params,
