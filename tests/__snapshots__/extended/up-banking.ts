...
export type IMySuperPrefixAccountsDetailDataMySuperSuffix =
  IMySuperPrefixGetAccountResponseMySuperSuffix;

export type IMySuperPrefixAccountsListDataMySuperSuffix =
  IMySuperPrefixListAccountsResponseMySuperSuffix;
...
export type IMySuperPrefixCategoriesDetailDataMySuperSuffix =
  IMySuperPrefixGetCategoryResponseMySuperSuffix;

export type IMySuperPrefixCategoriesListDataMySuperSuffix =
  IMySuperPrefixListCategoriesResponseMySuperSuffix;
...
export type IMySuperPrefixLogsDetailDataMySuperSuffix =
  IMySuperPrefixListWebhookDeliveryLogsResponseMySuperSuffix;
...
export type IMySuperPrefixPingCreateDataMySuperSuffix =
  IMySuperPrefixWebhookEventCallbackMySuperSuffix;

export type IMySuperPrefixPingListDataMySuperSuffix =
  IMySuperPrefixPingResponseMySuperSuffix;

export type IMySuperPrefixPingListErrorMySuperSuffix =
  IMySuperPrefixErrorResponseMySuperSuffix;
...
export type IMySuperPrefixRelationshipsTagsCreateDataMySuperSuffix = any;

export type IMySuperPrefixRelationshipsTagsDeleteDataMySuperSuffix = any;
...
export type IMySuperPrefixTagsListDataMySuperSuffix =
  IMySuperPrefixListTagsResponseMySuperSuffix;
...
export type IMySuperPrefixTransactionsDetailDataMySuperSuffix =
  IMySuperPrefixGetTransactionResponseMySuperSuffix;

export interface IMySuperPrefixTransactionsDetailParams1MySuperSuffix {
  /**
...
export type IMySuperPrefixTransactionsDetailResultMySuperSuffix =
  IMySuperPrefixListTransactionsResponseMySuperSuffix;

export type IMySuperPrefixTransactionsListDataMySuperSuffix =
  IMySuperPrefixListTransactionsResponseMySuperSuffix;
...
export type IMySuperPrefixWebhooksCreateDataMySuperSuffix =
  IMySuperPrefixCreateWebhookResponseMySuperSuffix;

export type IMySuperPrefixWebhooksDeleteDataMySuperSuffix = any;

export type IMySuperPrefixWebhooksDetailDataMySuperSuffix =
  IMySuperPrefixGetWebhookResponseMySuperSuffix;

export type IMySuperPrefixWebhooksListDataMySuperSuffix =
  IMySuperPrefixListWebhooksResponseMySuperSuffix;
...
> extends HttpClient<SecurityDataType> {
  accounts = {
    ...
    accountsDetail: (id: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixAccountsDetailDataMySuperSuffix, any>({
        path: `/accounts/${id}`,
        method: "GET",
        secure: true,
        ...params,
     ...
     */
    accountsList: (
      query: IMySuperPrefixAccountsListParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixAccountsListDataMySuperSuffix, any>({
        path: `/accounts`,
        method: "GET",
        query: query,
        secure: true,
    ...
    transactionsDetail: (
      {
        accountId,
        ...query
      }: IMySuperPrefixTransactionsDetailParams1MySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixTransactionsDetailResultMySuperSuffix, any>({
  ...
  categories = {
    ...
    categoriesDetail: (id: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixCategoriesDetailDataMySuperSuffix, any>({
        path: `/categories/${id}`,
        method: "GET",
        secure: true,
        ...params,
     ...
     */
    categoriesList: (
      query: IMySuperPrefixCategoriesListParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixCategoriesListDataMySuperSuffix, any>({
        path: `/categories`,
        method: "GET",
        query: query,
        secure: true,
  ...
  util = {
    ...
    pingList: (params: RequestParams = {}) =>
      this.request<
        IMySuperPrefixPingListDataMySuperSuffix,
        IMySuperPrefixPingListErrorMySuperSuffix
      >({
        path: `/util/ping`,
        method: "GET",
        secure: true,
  ...
  tags = {
     ...
     */
    tagsList: (
      query: IMySuperPrefixTagsListParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixTagsListDataMySuperSuffix, any>({
        path: `/tags`,
        method: "GET",
        query: query,
        secure: true,
  ...
  transactions = {
    ...
    relationshipsTagsCreate: (
      ...
      this.request<IMySuperPrefixRelationshipsTagsCreateDataMySuperSuffix, any>(
        {
    ...
    relationshipsTagsDelete: (
      ...
      this.request<IMySuperPrefixRelationshipsTagsDeleteDataMySuperSuffix, any>(
        {
          path: `/transactions/${transactionId}/relationships/tags`,
          method: "DELETE",
          body: data,
    ...
    transactionsDetail: (id: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixTransactionsDetailDataMySuperSuffix, any>({
     ...
     */
    transactionsList: (
      query: IMySuperPrefixTransactionsListParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixTransactionsListDataMySuperSuffix, any>({
        path: `/transactions`,
        method: "GET",
        query: query,
        secure: true,
  ...
  webhooks = {
     ...
     */
    logsDetail: (
      { webhookId, ...query }: IMySuperPrefixLogsDetailParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixLogsDetailDataMySuperSuffix, any>({
    ...
    pingCreate: (webhookId: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixPingCreateDataMySuperSuffix, any>({
     ...
     */
    webhooksCreate: (
      data: IMySuperPrefixCreateWebhookRequestMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixWebhooksCreateDataMySuperSuffix, any>({
        path: `/webhooks`,
        method: "POST",
        body: data,
        secure: true,
    ...
    webhooksDelete: (id: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixWebhooksDeleteDataMySuperSuffix, any>({
        path: `/webhooks/${id}`,
        method: "DELETE",
        secure: true,
        ...params,
    ...
    webhooksDetail: (id: string, params: RequestParams = {}) =>
      this.request<IMySuperPrefixWebhooksDetailDataMySuperSuffix, any>({
        path: `/webhooks/${id}`,
        method: "GET",
        secure: true,
        ...params,
     ...
     */
    webhooksList: (
      query: IMySuperPrefixWebhooksListParamsMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<IMySuperPrefixWebhooksListDataMySuperSuffix, any>({
        path: `/webhooks`,
        method: "GET",
        query: query,
        secure: true,
