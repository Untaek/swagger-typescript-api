...
export type IMySuperPrefixGetVersionDetailsv2DataMySuperSuffix = any;

export type IMySuperPrefixListVersionsv2DataMySuperSuffix = any;
...
> extends HttpClient<SecurityDataType> {
  ...
  listVersionsv2 = (params: RequestParams = {}) =>
    this.request<IMySuperPrefixListVersionsv2DataMySuperSuffix, void>({
      path: `/`,
      method: "GET",
      ...params,
    });
  ...
  v2 = {
    ...
    getVersionDetailsv2: (params: RequestParams = {}) =>
      this.request<IMySuperPrefixGetVersionDetailsv2DataMySuperSuffix, any>({
        path: `/v2`,
        method: "GET",
        ...params,
      }),
  ...
  withCharset = {
     ...
     */
    withCharset: (
      someParm: IMySuperPrefixWithCharsetPayloadMySuperSuffix,
  ...
  consumesPlainText = {
     ...
     */
    consumesPlainText: (
      someParm: IMySuperPrefixConsumesPlainTextPayloadMySuperSuffix,
      params: RequestParams = {},
    ) =>
      this.request<any, void>({
