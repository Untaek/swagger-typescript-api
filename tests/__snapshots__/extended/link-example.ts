...
export type IMySuperPrefixGetPullRequestsByRepositoryDataMySuperSuffix =
  IMySuperPrefixPullrequestMySuperSuffix[];
...
export type IMySuperPrefixGetRepositoriesByOwnerDataMySuperSuffix =
  IMySuperPrefixRepositoryMySuperSuffix[];

export type IMySuperPrefixGetRepositoryDataMySuperSuffix =
  IMySuperPrefixRepositoryMySuperSuffix;
